    ...
    <section class="section" id="explore">
        <div class="container">
            <div class="member-info">
                ...
                <br><br>
                <div>
                    <a>Account：<?php echo $Account; ?></a><br>
                    <a>Password：<?php echo $Member_password; ?></a><br>
                    <a>Name：<?php echo $Fullname; ?></a><br>
                    <a>Phone number：<?php echo $Phone; ?></a><br>
                    <a>Email：<?php echo $Mail; ?></a><br>
                </div>
